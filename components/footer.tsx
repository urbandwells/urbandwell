        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your trusted partner in finding the perfect property in Jagatpura, Jaipur and beyond.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/properties?type=penthouse" className="text-gray-400 hover:text-white">
                  Penthouses
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg
                  ...
                  className="h-5 w-5 text-red-600 mr-3 mt-1"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <span className="text-gray-400">123 Real Estate Avenue, Jagatpura, Jaipur, Rajasthan 302017</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
